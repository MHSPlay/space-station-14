...
[![Участники](https://contrib.rocks/image?repo=MHSPlay/space-station-14)](https://github.com/MHSPlay/space-station-14/graphs/contributors)

## Запуск

1. Склоинруйте репозиторий проекта с помощью команды `git clone`.
2. Запустите `RUN_THIS.py` чтобы инициализировать подмодули и загрузить движок.
3. Скомпилируйте решение `dotnet build`.
